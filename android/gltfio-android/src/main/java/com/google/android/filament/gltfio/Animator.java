...
public class Animator {
    ...
    public void updateBoneMatrices() {
        nUpdateBoneMatrics(mNativeObject);
    }
    ...
    private static native long nApplyAnimation(long nativeAnimator, int index, float time);
    private static native void nUpdateBoneMatrics(long nativeAnimator);
